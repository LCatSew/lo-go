...
//that returns a string for the corresponding SVG file 
//with the given shape color.
describe('Shapes', () => {
...
//You may need to add additional files in the lib folder 
//for handling user input, writing to a file, etc. 
